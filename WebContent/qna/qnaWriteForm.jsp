...
<body>
	<div class="container">
		<form method="post" id="freeFrm" action="<%=request.getContextPath()%>/qna/qnaWrite.do" class="form-horizontal">
			...
			<input type="submit" value="질문등록" class="form-control btn btn-outline-dark btn-sm"/>
		</form>
	</div>
</body>
</html>